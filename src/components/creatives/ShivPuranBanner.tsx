...
interface ShivPuranBannerProps {
  className?: string;
  orientation?: 'horizontal' | 'vertical' | 'square';
}

const ShivPuranBanner: React.FC<ShivPuranBannerProps> = ({ 
  className = '', 
      ...
      <div className="relative z-10 h-full">
        ...
        <div className="md:hidden flex flex-col items-center justify-center h-full p-4 text-center">
          <div className="relative w-28 h-28 rounded-lg shadow-xl overflow-hidden mb-3">
            <Image
              src="/banners/shiv-puran.jpg"
              alt="Shiv Puran Pandit"
              fill
          ...
          <p className="text-xs text-orange-700 italic mb-2">
            "Where every tale resonates with Om Namah Shivaya."
          </p>
          <p className="text-xs text-orange-500 font-medium mb-3">
            🌺 Ancient Wisdom & Divine Blessings 🌺
          </p>
          <div className="flex flex-col gap-2 mb-3">
            ...
            <Link href="/learn-more#shiv-puran" className="bg-white text-orange-600 border border-orange-400 px-4 py-2 rounded-full font-semibold text-xs shadow-lg text-center">
              Learn More
            </Link>
          </div>
          <div className="text-orange-500 text-xs font-medium">
            <div className="flex flex-wrap justify-center gap-3">
              <span>📖 Sacred Recitation</span>
              <span>🙏 Traditional Rituals</span>
              <span>🕉️ Spiritual Blessings</span>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center h-full gap-8 pl-24 pr-8">
          ...
          <p className="text-orange-600 text-sm font-medium tracking-wide mb-3">
            🔱 Embrace the Divine Power of Mahadev 🔱
          </p>
          ...
          <div className="flex gap-3 mb-4">
            ...
            <Link href="/learn-more#shiv-puran" className="bg-white hover:bg-orange-50 text-orange-600 border-2 border-orange-400 px-5 py-3 rounded-full font-semibold text-base shadow-lg transform hover:scale-105 transition-all duration-300 text-center">
              Learn More
            </Link>
          </div>
...
export default ShivPuranBanner;