      ...
      <div className="relative z-10 h-full">
        ...
        <div className="md:hidden flex flex-col items-center justify-center h-full p-4 text-center">
          ...
          <div className="flex flex-col gap-2 mb-3">
            ...
            <Link href="/learn-more#bhagwad-geeta" className="bg-white text-orange-600 border border-orange-400 px-4 py-2 rounded-full font-semibold text-xs shadow-lg text-center">
              Learn More
            </Link>
          </div>
        ...
        <div className="hidden md:flex items-center h-full gap-8 pl-24 pr-8">
          ...
          <div className="flex gap-3 mb-4">
            ...
            <Link href="/learn-more#bhagwad-geeta" className="bg-white hover:bg-orange-50 text-orange-600 border-2 border-orange-400 px-5 py-3 rounded-full font-semibold text-base shadow-lg transform hover:scale-105 transition-all duration-300 text-center">
              Learn More
            </Link>
          </div>
